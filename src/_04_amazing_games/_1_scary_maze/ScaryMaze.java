...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		// 1. Use this online tool ( /) to make a maze image. Size = 500x500
		// The maze must be drawn using 4 different colors, one each for: START, END,
		// BACKGROUND, and path.
	...
	private void scare() {
		...
		if (canPlaySounds) {
			...
			/********** PLAY A SOUND ***************/
			// 10. Find a scary sound and put it in the _04_amazing_games._1_scary_maze
			// package (where you put your maze picture).
			...
			// of your sound file
			String soundName = "standardScarySound.wav";
			playScarySound(soundName);
		}
		/********** SHOW A PICTURE ***************/
