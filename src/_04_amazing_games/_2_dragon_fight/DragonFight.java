...
dragonAttack =0;
	...
	String slashorshoot = JOptionPane.showInputDialog("Would you like to slash or shoot at the dragon.");
			...
			if(slashorshoot.equals("Secret12354666!!!")) {
				...
				String Secret =
				"Error....Dragon.exe c0rupted. Dragon AI shut down by unknown devel0per.\n"
...
dragonLost();			
				...
				// 		dragon have left.
JOptionPane.showMessageDialog(null,"The Player has "+playerHealth+" health left. The Dragon has "+dragonHealth+" health left");
